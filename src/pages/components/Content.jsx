...
import PlanCard from "./ContentComponents/PlanCard"
import UseCaseCard from "./ContentComponents/UseCaseCard";
        ...
        <main className="w-full bg-[#0a050f] text-white">
            <div className="max-w-[1200px] mx-auto pb-[120px]">
                ...
                <section className="mt-[32px] flex flex-col md:flex-row gap-[32px]">
                    <div className="w-1/2">
                        <h2 className="text-[48px] leading-[60px] font-semibold text-[#efe4f5]">
                            소상공인에서 지자체까지,
                            <br />
                            브랜드 사운드를 바로 완성합니다.
                        </h2>
                    ...
                    <div className="w-1/2 ">
                        <p className="text-[24px] leading-[32px] text-[#c2b4cf]">
                ...
                <section className="mt-[60px] flex justify-center">
                    <button
                        ...
                        className="px-[56px] py-[18px] rounded-[999px] bg-[#b52aff] hover:bg-[#c956ff] transition-colors text-[24px] font-semibold text-white shadow-lg"
                    >
                        바로송 제작 신청하기
                    </button>
                </section>
                ...
                <section className="w-full py-32">
                    <div className="mx-auto flex flex-col lg:flex-row items-center gap-[40px]">
                        ...
                        <div className="w-full lg:w-1/2 text-left">
                            <h2 className="text-[#DFD7E4] font-bold text-[44px] leading-[60px]  mb-[24px]">
                                아직도 가격으로 망설이십니까?
                            </h2>
                            <p className="text-[#DFD7E4] text-[24px] leading-[32px] mb-[6px]">
                            ...
                            <p className="text-[#DFD7E4] text-[24px] leading-[32px]">
                ...
                <section className="mt-[72px]">
                    <h3 className="text-[24px] font-semibold text-[#f0e6ff] mb-[20px]">
                        ‘바로송’은 다양한 분야에서 쓰입니다.
                    </h3>
